...
struct SV_9DOF_GBY_KALMAN
{
	...
	//int iFirstOrientationLock;	// denotes that 9DOF orientation has locked to 6DOF
...
public:
	...
	void fusionTask(struct AccelSensor *pthisAccel, struct MagSensor *pthisMag, struct fquaternion *pthisOrientMatrix, struct fquaternion *pthisOrientMatrixFused);
private:
	void fInit_9DOF_GBY_KALMAN(struct SV_9DOF_GBY_KALMAN *pthisSV, int ithisCoordSystem, int iSensorFS, int iOverSampleRatio);
	void fRun_9DOF_GBY_KALMAN_MANUS(struct SV_9DOF_GBY_KALMAN *pthisSV, struct AccelSensor *pthisAccel, struct MagSensor *pthisMag, struct fquaternion *pthisOrientMatrix, struct MagCalibration *pthisMagCal, int ithisCoordSystem, int iOverSampleRatio);
	void magCalRun(struct MagCalibration *pthisMagCal, struct MagneticBuffer *pthisMagBuffer); // magnetic calibration
	void fusionRun();
